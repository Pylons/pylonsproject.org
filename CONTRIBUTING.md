...
*   Fork this project and create a branch with your suggested change.
    ...
    When submitting a pull request, sign [CONTRIBUTORS.md](https://github.com/Pylons/pylonsproject.org/blob/master/CONTRIBUTORS.md) if you have not yet done so.
...
*   [master](https://github.com/Pylons/pylonsproject.org/) - The branch which should always be *deployable*.
